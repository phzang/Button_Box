...
toggle_switch_dictionary = {
    ...
    'MODEL_DA40': {
        "0": 'ENGINE_MASTER', # Uses keyboard hotkey because simconnect doesn't
                              # have an ENGINE_MASTER command
                              # Does not work currently, MSFS doesn't recognize
                              # pygame keyboard events, why?
        "1": 'TOGGLE_MASTER_BATTERY',
        "2": 'PITOT_HEAT_TOGGLE',
    ...
    'Cabri_G2': { 
        "0": 'ROTOR_GOV_SWITCH_TOGGLE',
        "1": 'NONE',
        "2": 'TOGGLE_MASTER_BATTERY',
        "3": 'STROBES_TOGGLE',
        "4": 'FUEL_PUMP',
        "5": 'TOGGLE_MASTER_ALTERNATOR',
        "6": 'ROTOR_CLUTCH_SWITCH_TOGGLE', 
        "7": 'TOGGLE_NAV_LIGHTS',
        "8": 'LANDING_LIGHTS_TOGGLE',
        "9": 'ANTI_ICE_TOGGLE', 
        "10": 'NONE',
